...
class EnvironmentTest(unittest.TestCase):
    ...
    def _test_extract_information(self,env):
        ...
        for inter_name in t_road_mapper:
            if inter_name not in road_mapper and len(t_road_mapper[inter_name]) == len(road_mapper[inter_name]):
                road_eq = False
                break;
        ...
        for inter_name in t_intersections:
            if inter_name not in road_mapper and len(t_intersections[inter_name]) == len(intersections[inter_name]):
                inter_eq = False
                break;
